...
export class AddMembersPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public dataProvider: DataProvider,
    public loadingProvider: LoadingProvider, public angularfire: AngularFire, public alertCtrl: AlertController,
        ...
        },
        {
          ...
          handler: data => {
            ...
            this.toAdd.forEach((friend) => {
              ...
              this.angularfire.database.object('/accounts/' + friend.$key + '/groups/' + this.groupId).update({
                messagesRead: 0
              });
