...
export class GroupInfoPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public dataProvider: DataProvider,
    ...
    public alertProvider: AlertProvider, public angularfire: AngularFire, public imageProvider: ImageProvider) { }
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            ...
            this.imageProvider.setGroupPhotoPromise(this.group, Camera.PictureSourceType.PHOTOLIBRARY).then((group) => {
              // Add system message.
              this.group.messages.push({
                date: new Date().toString(),
                sender: this.user.$key,
        ...
        },
        {
          ...
          handler: () => {
            ...
            this.imageProvider.setGroupPhotoPromise(this.group, Camera.PictureSourceType.CAMERA).then((group) => {
              // Add system message.
              this.group.messages.push({
                date: new Date().toString(),
                sender: this.user.$key,
        ...
        },
        {
          ...
          handler: data => {
            ...
            this.dataProvider.getGroup(this.groupId).update({
              ...
              this.angularfire.database.object('/accounts/' + firebase.auth().currentUser.uid + '/groups/' + this.groupId).remove().then(() => {
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: data => {
            ...
            this.angularfire.database.object('/accounts/' + firebase.auth().currentUser.uid + '/groups/' + group.$key).remove().then(() => {
